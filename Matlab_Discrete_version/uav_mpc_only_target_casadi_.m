...
subplot(3,1,1); plot(t,rad2deg(phi1_traj),'b','LineWidth',1.6); hold on; plot(t,rad2deg(phi2_traj),'g','LineWidth',1.2); ylabel('\phi [deg]'); grid on; legend('UAV1','UAV2'); xlim([t(1), t(end)]);
subplot(3,1,2); plot(t,rad2deg(theta1_traj),'b','LineWidth',1.6); hold on; plot(t,rad2deg(theta2_traj),'g','LineWidth',1.2); ylabel('\theta [deg]'); grid on; xlim([t(1), t(end)]);
subplot(3,1,3); plot(t,rad2deg(psi1_traj),'b','LineWidth',1.6); hold on; plot(t,rad2deg(psi2_traj),'g','LineWidth',1.2); ylabel('\psi [deg]'); xlabel('time [s]'); grid on; xlim([t(1), t(end)]);
