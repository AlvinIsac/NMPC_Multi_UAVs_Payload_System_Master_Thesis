...
public:
  UAV1HoverController() : Node("UAV1_hover_controller") {
    ...
    control_timer_ = create_wall_timer(
      std::chrono::milliseconds(20),  // E.g. 100 Hz (1000 ms / 100 = 10 ms) put here 1000/(what hz you want)
...
private:
  ...
  void controlLoop() {
    ...
    try {
      ...
      cmd_uav1.setpoint[0] = static_cast<float>(tau_pitch_uav1);
      cmd_uav1.setpoint[1] = static_cast<float>(tau_roll_uav1);
