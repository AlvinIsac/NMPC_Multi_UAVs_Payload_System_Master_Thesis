...
if __name__ == "__main__":
    ...
    parser.add_argument('--qgc_udp_port', default=14550, help="QGroundControl interface UDP port")
    parser.add_argument('--sdk_udp_port', default=14540, help="SDK interface UDP port")
